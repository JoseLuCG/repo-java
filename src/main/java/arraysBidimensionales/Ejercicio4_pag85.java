/* Ejercicio 4
    Modifica el programa anterior de tal forma que las sumas parciales
y la suma total aparezcan en la pantalla con un pequeño retardo, dando
la impresión de que el ordenador se queda “pensando” antes de mostrar
los números. */
...
public class Ejercicio4_pag85 {
     ...
     */
    public static void showMatrix (int[][] matrix, int[] data, int[] dataCols) throws InterruptedException{
        ...
        for (int f = 0; f < matrix.length; f++) {
            ...
            Thread.sleep(1000);
            System.out.printf(BLUE+" %7d |",data[f]);
